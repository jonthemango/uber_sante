...
import NewDoctorItem from './NewDoctorItem';
...
class LoggedAdmin extends Component {
    ...
    async fetchRooms(clinicId){
      ...
      if(result.success) {
          ...
          console.log(clinic)
          this.setState({rooms: clinic.rooms, clinic: clinic})
    ...
    render() {
        ...
        <Nav tabs>
          <NavItem>
            ...
            >
              Clinics ({this.state.clinics.length})
            </NavLink>
          </NavItem>
          <NavItem>
            <NavLink
          ...
          <NavItem>
            <NavLink disabled={this.state.hideClinic}
              className={classnames({ active: this.state.activeTab === 'clinic' })}
              onClick={() => { this.toggle('clinic'); }}>

              {this.state.clinic.name != "" ? this.state.clinic.name : "No Clinic Selected"} ({this.state.clinic.name != "" ? "1" : "0"})
          ...
          <NavItem>
            <NavLink 
              className={classnames({ active: this.state.activeTab === 'api' })}
              onClick={() => { this.toggle('api'); }}
            >
              API
            </NavLink>
          </NavItem>
        ...
        <TabContent activeTab={this.state.activeTab}>
          <TabPane tabId="1">
            <Row>
              ...
              <div style={{marginBottom: "4em"}}>
                        <h2>{this.state.clinic.name != "" ? this.state.clinic.name : "Clinics"}</h2>
          ...
          <TabPane tabId="clinic">
            <Row>
              ...
              <div>
                ...
                <ListGroup>
                  <ListGroupItem><b>Clinic name:</b> {this.state.clinic.name}</ListGroupItem>
                  <ListGroupItem><b>Number of Rooms:</b> {this.state.rooms.length}</ListGroupItem>
                  <ListGroupItem><b>Clinic Id:</b> {this.state.clinic._id}</ListGroupItem>
                </ListGroup>
                <Map></Map>           
          ...
          <TabPane tabId="3">
            <Row>
              ...
              <div>
                <h2>Doctors</h2>
                        <NewDoctorItem reFetch={this.fetchDoctors} {...this.state} />
						<Background>
                  ...
                  <tbody>
                  {this.state.doctors.map(item => <DoctorItem {...item} reFetch={this.fetchDoctors} {...this.state}/>)}
             </tbody>
             </Table>
			 </Background>
